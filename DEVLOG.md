...
| 항목 | 내용 |
|---|---|
| **현재 위치** | M1 완료 — M2(핵심 기능 확장) 착수 예정 |
| **완료** | Prisma 스키마 및 마이그레이션 · Express 서버 · 회원가입/로그인 API · JWT 인증 · 일기 CRUD 4종 · React+Vite+Tailwind 스캐폴딩 · axios 인스턴스 · 로그인/회원가입/메인/일기 작성/일기 상세 화면(UI-001~005) · 인증 가드(ProtectedRoute) |
| **다음 작업** | M2 착수 — 사진 업로드 / 음악 기록 / 위치·태그 기능, 검색, 통계 (`ROADMAP.md` Milestone 2 참조) |
...
- Repository · `sagming40/onepage` (Public) · `main`에 PR #1~#5 병합 완료, 관련 feature 브랜치 전부 삭제
