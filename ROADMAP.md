...
> - v2.9 — M2 태그 기능 완료 처리, 위치 기록 항목을 M1 선행 완료로 정정(각주 전환), 일기 수정 화면 항목 신설
...
| [Milestone 2](#milestone-2--핵심-기능-확장) | 핵심 기능 확장 | 🔄 진행중 |
...
- [ ] 사진 업로드
- [ ] 음악 기록
> 위치 기록은 M1 일기 작성 화면(UI-004) 구현 시 이미 완료됨 — 완료 여부의 출처는 M1 작업 목록 참조
- [x] 태그 기능
- [ ] 일기 수정 화면
